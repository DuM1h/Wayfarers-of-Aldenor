...
public class PlayerControllerView : CharacterView
{
    ...
    {
        if (_logicalCharacter == null || _logicalCharacter.Stats.IsDead || _isMovingSmoothly || _currentPath.Count > 0)
        {
            ClearPathPreview();
            return;
        }
    ...
    protected override void Update()
    {
        ...
        if (_logicalCharacter == null || _logicalCharacter.Stats.IsDead) return;
